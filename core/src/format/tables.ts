...
//
// Computes table-alignment edits for a Gherkin document.
//
// Returns plain line replacements; turning them into editor edits is the host's
// job. Datatables are left-aligned throughout; Examples tables right-align
// columns whose body cells are all numeric, with headers always left-aligned.
